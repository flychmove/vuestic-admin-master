  ...
  export default defineComponent({
    ...
    methods: {
      ...
      onchange(id) {
        ...
        this.orderidInfo = this.orders[id].id
      ...
      addhandleSubmit () {
        ...
        this.updateOrderInfo.mealOrder.tableId = null
        this.updateOrderInfo.mealOrder.isCompleted = null
        this.updateOrderInfo.orderList.x = null
        this.updateOrderInfo.orderList.y = null
        this.getAll();
      },
      /*搜索*/
      ...
      handleAddSubmit(e){
        ...
        this.showModal2 = !this.showModal2
        this.addOrderInfo.mealOrder.tableId = ""
        this.addOrderInfo.mealOrder.isCompleted = ""
        this.addOrderInfo.orderList.x = null
        this.addOrderInfo.orderList.y=null
        this.getAll();
      }
    },
    created() {
